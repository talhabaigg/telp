...
/** Props for the TelpLogo component (SVG React). */
export interface TelpLogoProps {
    /** Tailwind classes for the wrapper. @default "w-52 h-16" */
    className?: string;
    /** Accessible title for screen readers. @default "TELP Logo" */
    title?: string;
}

/**
 * Generate TELP logo as raw SVG string for use in data URLs (favicon/mask-icon).
 */
...
<svg viewBox='0 0 300 80' xmlns='http://www.w3.org/2000/svg' role='img' aria-label='TELP Logo'>
  ...
  ${withTagline ? `<text x='10' y='75' font-family='Montserrat, Arial, sans-serif' font-weight='400' font-size='18' fill='${t}'>custom enterprise solution</text>` : ``}
</svg>`.trim();
}

/** React SVG version of the logo. */
